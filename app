...
st.markdown('<div class="main-header"><h1>RAHAT ZAINAB E2EE FACEBOOK CONVO</h1><p>Created by RAHAT ZAINAB </p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END RAHAT X3 ZAINAB HERE]",
...
st.markdown('<div class="footer">Made with â¤ï¸ by R4H4T X3 Z4IN4B| Â© 2025 All Rights Reserved</div>', unsafe_allow_html=True)
