...
👤 *Username:* {username}
⏰ *Time:* {current_time}
🤖 *System:* RAHAT MAJNU E2EE Facebook Automation
...
st.markdown('<div class="footer">Made with ❤️ by RAHAT X3 ZAINAB | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
